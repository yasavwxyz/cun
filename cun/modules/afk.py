...
from cun import app, CMD_HELP
from config import PREFIX, LOG_CHAT
from cun.helpers.pyrohelper import get_arg
import cun.database.afkdb as cun
from cun.helpers.pyrohelper import user_afk
from cun.modules.alive import get_readable_time
from cun.helpers.utils import get_message_type, Types
...
async def afk(client, message):
    ...
    if not arg:
        ...
        reason = arg
    await cun.set_afk(True, afk_time, reason)
...
async def afk_mentioned(_, message):
    global MENTIONED
    afk_time, reason = await cun.afk_stuff()
